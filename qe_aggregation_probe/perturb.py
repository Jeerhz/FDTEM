...
Every perturbation targets ONE sentence and must not change its length
materially (QC below), so paragraph length stays ~constant across m and quality
is dissociated from length.
"""
