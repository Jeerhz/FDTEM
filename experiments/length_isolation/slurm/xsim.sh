...
#
# Usage:
#   sbatch experiments/length_isolation/slurm/xsim.sh
#   LANGS="de es fr ru zh ja" K_LIST="2 3 4 5 6" sbatch experiments/length_isolation/slurm/xsim.sh
#
...
srun python experiments/length_isolation/run_xsim.py \
  --encoders "${ENCODERS[@]}" \
