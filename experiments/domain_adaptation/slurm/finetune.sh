...
#
# Usage:
#   bash experiments/domain_adaptation/slurm/finetune.sh [--gpus 2] [--run_name my_run]
# ──────────────────────────────────────────────────────────────────────────────
set -euo pipefail
...
# ── 6. run training ───────────────────────────────────────────────────────────
# We use experiments/length_training/train.py instead of comet-train because jsonargparse
...
echo "  python archive/upload_to_huggingface.py \\"
