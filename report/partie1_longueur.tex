...
%  à partir de part1_block_alignment/results/duel.json et
%           de part1_block_alignment/results/comet_score.json
...
\graphicspath{{figures/}{../part1_block_alignment/figures/}}
...
$A(D)$ est \code{1 - by\_duel\_size[D].duel\_err} dans \code{part1\_block\_alignment/results/duel.json}, et \code{shortlist\_accuracy} dans \code{part1\_block\_alignment/results/comet\_score.json}.
...
python -m part1_block_alignment.perturb --langs de es fr ru --pivot en --direction en2xx \
  --k_list 1 2 3 4 5 --backend spacy --seed 42
python -m part1_block_alignment.evaluate_duel \
  --encoders comet:Unbabel/wmt22-comet-da hf-mean:xlm-roberta-large labse e5 \
  --langs de es fr ru --k_list 2 3 4 5 --duel_sizes 6 5 4 --backend spacy
\end{verbatim}
...
python -m part1_block_alignment.evaluate_comet_score \
  ...
  --langs de es fr ru --k_list 1 2 3 4 5 --backend spacy \
  --negatives_per_block 6 --shortlist_size 3 --seed 42
\end{verbatim}
